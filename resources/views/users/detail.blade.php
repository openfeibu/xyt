...
<tr><td align="center" style=" color:#56ba3c;">{!!$basic_data['sex']['value'][$user->sex]!!}</td><td>   <span>关注：</span><span class="green">{{$user->following_count}}</span>  <span>粉丝：</span><span class="green">{{$user->follower_count}}</span><span>人气：</span><span class="green">{{$user->view_count}}</span></td></tr>
</table>
<div class="l_ahovera">
