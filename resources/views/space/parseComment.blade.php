<dl class="b_nc" class="comment_list"  model-node="comment_list">
	...
	<dd class="b_ne" style="margin-top:0px">
		<a href="javascript:void(0)" event-args='row_id={{$row_id}}&app_uid={{$app_user_id}}&to_comment_id={{$comment_id}}&to_uid={{$userInfo['id']}}&to_comment_uname={{$userInfo['username']}}' event-node="reply_comment">{{trans('public.PUBLIC_STREAM_REPLY')}}</a>&nbsp;<a href="#" class="jubaoshow">举报</a>
	</dd>
</dl>