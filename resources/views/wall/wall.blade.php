			<div class="" style="color:#696969;">
	            ...
	            <div id="walllist_{{$post_id}}" class="comment_lists reply_lists">
				...
				<div class="com_form reply" model-node="comment_textarea">
		            ...
		            <div class="action clearfix" style="    width: 600px;">
		                <div class="kind">
		                    ...
		                    <div class="fright release">  <a class="btn-green-big btn" event-node="do_weiba_reply" event-args="" href="javascript:;"  post_id="{{$post_id}}"   to_reply_id="0" to_user_id="0"  addtoend="{{$addtoend}}" url="{{route('wall.add_wall')}}" list_count={{ $count }}  > <span>留言</span> </a> </div>
