...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'Hifone\Events\Space\SpaceWasAddedEvent' => [
            'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
        'Hifone\Events\Space\SpaceWasRemovedEvent' => [
            'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
		'Hifone\Events\Comment\CommentWasAddedEvent' => [
            'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
        'Hifone\Events\Comment\CommentWasRemovedEvent' => [
            'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
        'Hifone\Events\Vote\VoteWasAddedEvent' => [
            'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
        'Hifone\Events\Vote\VoteWasRemovedEvent' => [
            'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
        'Hifone\Events\Album\AlbumPhotoWasRemovedEvent' => [
			'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
        'Hifone\Events\Album\AlbumPhotoWasUploadedEvent' => [
			'Hifone\Handlers\Listeners\Credit\AddCreditHandler',
        ],
