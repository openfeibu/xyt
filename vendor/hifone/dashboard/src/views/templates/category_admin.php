						...
						<!-- ko if: column_name === 'operation' -->
							<td id="model_row_cell_operation">
								...
								<div class="operation-row">
									...
									<a href ="javascript:void(0)" class="btn btn-primary btn-sm" data-blid="">
										<i class="fa fa-gear" aria-hidden="true"></i>
									</a>
									

									<a href ="javascript:void(0)" class="btn btn-primary btn-sm" data-bind="click: function() {$('.item_edit_container').fadeIn();$('#sidebar').fadeOut();$root.clickCategoryItem(0,$parent[$root.primaryKey].raw); return true}">
