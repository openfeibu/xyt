			<div class="" style="color:#696969;">
	            <h3 class="feed_header"> <div class="r_option"><span id="comment_replynum"></span> </div>留言（<span id="reply_count"><?php echo e($count); ?></span>个）</h3>
				...
				<div class="com_form reply" model-node="comment_textarea">	                
		            ...
		            <div class="action clearfix" style="    width: 600px;">
		                <div class="kind">
		                    ...
		                    <div class="fright release">  <a class="btn-green-big btn" event-node="do_weiba_reply" event-args="" href="javascript:;"  post_id="<?php echo e($post_id); ?>"   to_reply_id="0" to_user_id="0"  addtoend="<?php echo e($addtoend); ?>" url="<?php echo e(route('wall.add_wall')); ?>" list_count=<?php echo e($count); ?>  > <span>留言</span> </a> </div>
            ...
            <script>
	            var parameter = {'post_id': <?php echo e($post_id); ?>,'limit':'5','addtoend':0 };
	            url = "<?php echo e(route('wall.wall')); ?>";
				ajaxget(url, 'walllist_<?php echo e($post_id); ?>',parameter);
        	</script>