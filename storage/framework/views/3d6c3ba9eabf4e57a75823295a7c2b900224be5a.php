                    ...
                    <div style="color: #787878;height: 550px;width: 800px;padding-top: 25px;margin: 0 auto;">
                        ...
                        <table style="border: 1px #F2C4D7 solid;width: 100%;text-align: center;">
                            ...
                            <tr>
                                ...
                                <td><?php echo handerStar($star['real_name_status']); ?></td>
                                <td><?php echo handerStar(1); ?></td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px;">学历认证</td>
                                <td><span style="color: red">通过本站学历认证</span></td>
                                <td>未通过认证&nbsp;>>&nbsp;<span style="color: red">立即认证</span></td>
                                <td><?php echo handerStar($star['education_status']); ?></td>
                                <td><?php echo handerStar(1); ?></td>
                            </tr>
                            <tr>
                                ...
                                <td>未通过认证&nbsp;>>&nbsp;<span style="color: red">立即认证</span></td>
                                <td><?php echo handerStar($star['mobile_status']); ?></td>
                                <td><?php echo handerStar(1); ?></td>
                            </tr>
                            <tr class="tab_tr">
                                ...
                                <td>
                                    设置形象照（<?php echo e($star['profiles']['avatar']['schedule']); ?>）<br />
                                    基本资料（<?php echo e($star['profiles']['basic']['schedule']); ?>）<br />
                                    择偶标准（<?php echo e($star['profiles']['standard']['schedule']); ?>）<br />
                                    个性资料（<?php echo e($star['profiles']['detail']['schedule']); ?>）<br />
                                    内心独自（<?php echo e($star['profiles']['dating']['schedule']); ?>）<br />
                                    幸福宣言（<?php echo e($star['profiles']['happy']['schedule']); ?>）
                                </td>
                                <td><?php echo handerStar($star['profile_status']); ?></td>
                                <td><?php echo handerStar(1); ?></td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px;">魅力星级</td>
                                <td>个人主页访问量超过1000</td>
                                <td>当前访问人数：<span style="color: #0078B6"><?php echo e($user->view_count); ?></span></td>
                                <td><?php echo handerStar($star['charm_status']); ?></td>
                                <td><?php echo handerStar(1); ?></td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px;">推广星级</td>
                                <td>邀请好友注册数目超过10人</td>
                                <td>已邀请人数：<span  style="color: #000"><?php echo e($user->invite_count); ?></span>&nbsp;>>&nbsp;<span style="color: red">立即邀请</span></td>
                                <td><?php echo handerStar($star['invite_status']); ?></td>
                                <td><?php echo handerStar(1); ?></td>
                            </tr>
                        </table>
