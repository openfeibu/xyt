<div class="list" id="item_<?php echo e($reply_id); ?>">
	<dl class="b_nc" model-node="comment_list">
		...
		<dd class="b_ne" style="margin-top:0px">
			<a href="javascript:void(0)" event-args="post_id=<?php echo e($post_id); ?>&post_user_id=<?php echo e($post_user_id); ?>&to_reply_id=<?php echo e($reply_id); ?>&to_user_id=<?php echo e($user_id); ?>&to_comment_uname=<?php echo e($user_info['username']); ?>&id=<?php echo e($reply_id); ?>&space_id=<?php echo e($space_id); ?>&addtoend=<?php echo e($addtoend); ?>" event-node="reply_reply"><?php echo e(trans('public.PUBLIC_STREAM_REPLY')); ?></a>&nbsp;
