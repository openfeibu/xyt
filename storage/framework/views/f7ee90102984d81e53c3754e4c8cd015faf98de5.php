            ...
            <div class="Options">
               <ul>
					...
					<a href="<?php echo e(route('search.city')); ?>">
						<li id="tow3" onclick="setTab('tow',3)" style="color:#51B837">&nbsp;查找同城的人 <span>|</span></li>
					</a>
                    ...
                    <form action="<?php echo e(route('search.result',['page'=>1])); ?>" method="get">
                        ...
                        <table class="table_tow">
                            <tr>
                                ...
                                <td>
                                    <select name="residence_province" id="">
                                        <option value="">省份</option>
										<option value="广东">广东</option>
                                    </select>
                                    <select name="residence_city" id="">
