			<div class="" style="color:#696969;">
	            <h3 class="feed_header"> <div class="r_option"><span id="comment_replynum"></span> </div>评论（<span id="reply_count"><?php echo e($list->count); ?></span>个）</h3>
	            <div id="commentlist_<?php echo e($post_id); ?>" class="comment_lists reply_lists">
		            ...
		            <div class="list" id="item_<?php echo e($vo->id); ?>">
				        <dl class="b_nc" model-node="comment_list">
							...
							<dd class="b_ne" style="margin-top:0px">
								<a href="javascript:void(0)" event-args="post_id=<?php echo e($post_id); ?>&post_user_id=<?php echo e($post_user_id); ?>&to_reply_id=<?php echo e($vo->id); ?>&to_user_id=<?php echo e($vo->user_id); ?>&to_comment_uname=<?php echo e($vo->user_info['username']); ?>&id=<?php echo e($vo->id); ?>&space_id=<?php echo e($space_id); ?>&addtoend=<?php echo e($addtoend); ?>&post_from=<?php echo e($post_from); ?>" event-node="reply_reply"><?php echo e(trans('public.PUBLIC_STREAM_REPLY')); ?></a>&nbsp;
				...
				<div class="com_form reply" model-node="comment_textarea">	                
	                <?php echo Form::open(['id' => 'space_create_form','method' => 'post','model-node' => 'mini_editor']); ?>
		            ...
		            <div class="action clearfix" style="    width: 600px;">
		                <div class="kind">
		                    ...
		                    <div class="fright release">  <a class="btn-green-big btn" event-node="do_weiba_reply" event-args="" href="javascript:;"  post_id="<?php echo e($post_id); ?>"  post_user_id="<?php echo e($post_user_id); ?>"  to_reply_id="0" to_user_id="0" post_from="<?php echo e($post_from); ?>"  space_id="<?php echo e($space_id); ?>" addtoend="<?php echo e($addtoend); ?>" list_count=<?php echo e($list->count); ?>  > <span>评论</span> </a> </div>
