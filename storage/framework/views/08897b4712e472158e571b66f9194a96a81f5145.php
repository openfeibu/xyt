...
<?php echo e($user->username); ?> <?php echo e(trans('hifone.favorites.favorites')); ?>_@parent
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <?php if(count($threads)): ?>
	      ...
	      <div class="pull-right add-padding-vertically"> <?php echo e($threads->render()); ?> </div>
      <?php else: ?>
        <div class="empty-block"><?php echo e(trans('hifone.favorites.noitem')); ?></div>
      <?php endif; ?>
