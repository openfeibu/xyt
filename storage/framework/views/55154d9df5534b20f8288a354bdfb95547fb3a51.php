    ...
    <div class="activity">
        ...
        <div class="activity_place">
            ...
            <div class="activity_place_right fleft">
                <ul>
                    <a href="<?php echo e(route('activity.index',['cat_id' => $cat_id])); ?>"><li <?php if(!$province_id): ?>class="selected"<?php endif; ?>>全部</li></a>
                    <?php foreach($provinces as $key => $province): ?>
                    <a href="<?php echo e(route('activity.index',['province_id' => $province->id,'cat_id' => $cat_id])); ?>" ><li <?php if($province->id == $province_id): ?>class="selected"<?php endif; ?>><?php echo e($province->title); ?></li></a>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
        ...
        <div class="activity_type">
            ...
            <div class="activity_type_right fleft">
                <ul>
                    <a href="<?php echo e(route('activity.index',['province_id' => $province_id])); ?>"><li <?php if(!$cat_id): ?>class="selected"<?php endif; ?>>全部</li></a>
                    <?php foreach($cats as $key => $cat): ?>
                    <a href="<?php echo e(route('activity.index',['province_id' => $province_id,'cat_id' => $cat->id])); ?>"><li <?php if($cat->id == $cat_id): ?>class="selected"<?php endif; ?>><?php echo e($cat->title); ?></li></a>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
