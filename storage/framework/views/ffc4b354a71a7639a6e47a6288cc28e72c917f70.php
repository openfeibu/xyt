<?php if($send_type =='send_space'): ?>
<div class="send_weibo diy-send-weibo" model-node="send_weibo" id="send_weibo">
    <div class="b_hr_title">
        <p class="p1">我们在倾听与分享此刻您的心情</p>
        <div class="p2">您还可以输入 <div color="red" size="4"  model-node="numsLeft" class="num" style="display: inline;"><?php echo e($initNums); ?></div> 字</div>
    </div>
    <div class="com_form">
        
        <?php echo Form::open(['route' => 'space.store','id' => 'space_create_form','method' => 'post','model-node' => 'mini_editor']); ?>

            <?php echo Form::textarea('at',null,['id' => 'saytext' ,'class'=>'input_tips','event-node'=>'mini_editor_textarea','model-args'=>'t=feed']); ?>
...
<div model-node="weibo_post_box" class="clearfix">
  <div class="input_before" model-node="mini_editor" style='margin:0 0 5px 0'>
    <textarea id="message_inputor" class="input_tips" event-node="mini_editor_textarea" event-args='parentHeight=60' model-args="t=repostweibo" style="height: 61px; width: 447px; margin: 0px;"><?php echo e($initHtml); ?></textarea>
    <div model-node="numsLeft" class="num"><?php echo e($initNums); ?></div>
  </div>
  <div class="action clearfix"> <a href="javascript:;" class="btn-green-big right" event-node='post_share' event-args='sid=<?php echo e($sid); ?>&type=<?php echo e($stype); ?>&app_name=<?php echo e($app_name); ?>&curid=<?php echo e($curid); ?>&curtable=<?php echo e($curtable); ?>'><span><?php echo e(L('PUBLIC_SHARE_STREAM')); ?></span></a>
