...
<script src="<?php echo e(asset('/build/dist/js/jquery.uploadify.js')); ?>" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('/build/dist/css/uploadify.css')); ?>">
<div class="clear"></div>
    <div class="TA">
        <div class="b_ja">
            <img src="<?php echo e(asset('images/photologo.png')); ?>" alt="" /><span style="color: #aaa;font-size: 16px;">相册</span>
        </div>
        <div class="clear"></div>
        <div class="content">
            <div class="tab1s" id="b_hb">
                ...
                <div class="creat_photo_div" id="creat_photo" style="display: none;">
                    ...
                    <form action="<?php echo e(route('album.upload_common_handle')); ?>" method="post">
                ...
                <div class="batch_upload fleft" style="width: 598px;" >
                    ...
                    <div class="prompt clear" >
                        ...
                        <p>
                            <img src="<?php echo e(asset('images/add_space.png')); ?>" alt="" />
                    ...
                    <div class="my_classify_photo">
                        <div class="my_classify_list">
                            <dl>
                                <dd><img src="<?php echo e(asset('images/TAhphoto.png')); ?>" alt="" /></dd>
                    ...
                    <div class="reward" id="buy_add" style="display: none;width: 500px;height: 350px;margin-left: 300px;margin-top: -300px;">
                        ...
                        <form action="">
                            <div class="email_left fleft">
                                <img src="<?php echo e(asset('images/buy_add.png')); ?>" alt="" />
                            </div>
...
<script>
    ...
    $(function(){
	    $("#creat_photo_submit").click(function(){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo e(route('album.store')); ?>",
		...
		$('#file_upload').uploadify({
			...
			'swf'      : "<?php echo e(asset('/build/dist/images/uploadify.swf')); ?>",
			'uploader' : "<?php echo e(route('album.upload_common_handle')); ?>",
			'auto' : false,
			'fileSizeLimit' : '1MB',
			'cancelImg'      : "<?php echo e(asset('/build/dist/images/uploadify-cancel.png')); ?>", 
			'file_queue_limit' : 5,		
