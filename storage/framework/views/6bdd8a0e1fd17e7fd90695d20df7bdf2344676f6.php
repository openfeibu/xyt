<div class="img-list clearfix">
  <ul id="ul_<?php echo e($unid); ?>">
		<li id="btn_<?php echo e($unid); ?>"><input style="display:none" name="uploadify_<?php echo e($unid); ?>" id="uploadify_<?php echo e($unid); ?>" type="file" /></li>
  </ul>
</div>
...
core.loadFile(THEME_URL+'/js/uploadify/jquery.uploadify.min.js', function () {
	var unid = "<?php echo e($unid); ?>",
			fileSizeLimit = "<?php echo e($fileSizeLimit); ?>",
	...
	$('#uploadify_'+unid).uploadify({
    	...
    	fileTypeExts: " <?php echo e($fileTypeExts); ?>",
		swf: THEME_URL + '/js/uploadify/uploadify.swf',
		uploader: '/upload/save',
		width: 80,
		height: 80,
		buttonImage: THEME_URL + '/build/dist/images/add-photo-multi.png',
		queueSizeLimit: 9,
		queueID: true,
		...
		onUploadSuccess : function(file, data, response) {
			...
			if (jsondata.status === 1) {
				// 添加附件ID表单项目
				var $sendAction = $('div[model-node="send_action"][unid="'+unid+'"]');
