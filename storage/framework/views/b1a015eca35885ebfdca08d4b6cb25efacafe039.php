	...
	<div class="b_l">
		...
		<div class="d_reg b_k" id="firstform">
			<div class="d_reg_head">
				...
				<div class="d_reg_headb fright" >已有象牙塔网站账号 <a href="<?php echo e(route('auth.login')); ?>">我要登录</a></div>
			</div>
			<table  border="1" class="t_reg ">
			  ...
			  <tr>
				...
				<td colspan="2">
					<?php echo e(Widget::Areas([ 'type'=> 'reg_location','name' => 'location' ,'province_name' => 'province','city_name' => 'city','prefix' => ''] )); ?>
		...
		<div class="b_k" id="nextform">
			<div class="d_reg_1_head">
				<img src="<?php echo e(asset('/build/dist/images/reg1.jpg')); ?>" />
			</div>
			...
			<div class="d_reg_main">
				...
				<table  border="0" class="t_reg_1" width="100%">
				  <tr>
					<td width="86">*职业：  </td>
					<td colspan="2">
						<?php echo $formTypePresenter->showSelect($base_data,'work',''); ?>
	...
	<div class="message">
        ...
        <div class="message_main">
        	<div class="pcontent">
                ...
                <p style="margin-top: 35px;"><img src="<?php echo e(asset('/build/dist/images/xyt.jpg')); ?>" width="25" height="44"  class="xyt"/>象牙塔网是一个真实靠谱的高校交友平台，如果您符合以上3点，</p>
...
$("#sendcode").on('click',function(){
	...
	if(reg.test(mobile)){
		...
		$.get("<?php echo e(route('user.register_mobile')); ?>"+'?mobile='+mobile,function(data){
			if(data.code==200){
