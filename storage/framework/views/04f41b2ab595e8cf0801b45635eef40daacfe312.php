            ...
            <div class="Options">
                <ul>
					...
					<a href="<?php echo e(route('search.colleague')); ?>">
						<li id="tow7" onclick="setTab('tow',7)" style="color:#51B837">&nbsp;查找你的同事 <span>|</span></li>
					</a>
                ...
                <div id="con_tow_7">
                    ...
                    <form action="<?php echo e(route('search.result',['page'=>1])); ?>" method="get">
                        ...
                        <table class="table_tow">
                            <tr>
                                <td align="right">公司或机构：</td>
                                <td>
                                    <input type="text" name="company" class="Options_input"/>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">部门：</td>
                                <td>
                                    <input type="text" name="branch" class="Options_input"/>
                                </td>
                            </tr>
                            <tr>
