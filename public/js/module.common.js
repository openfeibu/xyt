...
var share=function(sid,stable,initHTML,curid,curtable,appname,cancomment,is_repost){
	...
	var url = SHARE_SPACE_URL +'?sid='+sid+'&stable='+stable+'&curid='+curid+'&curtable='+curtable+'&appname='+appname+'&initHTML='+initHTML+'&cancomment='+cancomment+'&is_repost='+is_repost;
...
message.getMessage = function(type) {
	...
	$dl.html('<p class="loadding"><img src="' + THEME_URL + '/images/icon_waiting.gif" /></p>');
