core.groupfeed = {
		...
		init:function(agrs) {
			...
			if($('#group-feed-lists').length > 0 && this.canLoading){
				$('#group-feed-lists').append("<div class='loading' id='loadMore'>" + L('PUBLIC_LOADING') + "<img src='" + THEME_URL + "/images/ico-load.png' class='load'></div>");
		...
		loadMoreByPage: function(href) {
			...
			$('#group-feed-lists').html("<div class='loading' id='loadMore'>" + L('PUBLIC_LOADING') + "<img src='" + THEME_URL + "/images/ico-load.png' class='load'></div>");
