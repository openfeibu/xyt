			...
			　var _this = this;
			 core.loadFile(THEME_URL+'/js/jquery.form.js',function(){
				...
				if($(_this.resultDiv).find('.loading').size() < 1 ){
					$(_this.resultDiv).find('ul').eq(0).append('<li class="loading"><div class="loads"><img src="'+THEME_URL+'/images/load.gif" style="width:auto;height:auto"></div><p class="tips upload_tips" style="padding:5px"><a href="javascript:core.uploadFile.stopupload()">'+L('PUBLIC_REMOVE_UPLOAD')+'</a></p></li>');	
				}
