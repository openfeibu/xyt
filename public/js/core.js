...
var _core = function() {
	...
	this._createImageHtml = function() {
		...
		var _c = function() {
			if(_imgHtml == '') {
				$.post(GET_SMILE_URL, {}, function(data) {
					for(var k in data) {
						_imgHtml += '<a href="javascript:void(0)" title="'+data[k].title+'" onclick="core.face.face_chose(this)";><img src="'+ THEME_URL +'/images/arclist/'+ data[k].filename +'" width="24" height="24" /></a>';	
					}
...
$(function() {
	...
	// 		_this.attr('src',THEME_URL+'/avatar/images/noavatar/big.jpg');
	// 　　}else{
	// 		_this.attr('src','');
	// 	}
	// })
